...
### Alternative App: ReSimulate
Based on the idea of this webapp, a free Android App was recently (08.2019) published which does not require a server connection but instead connects two devices via Wifi/Bluetooth. If you are interested, head over to [ReSimulate](https://www.resimulate.de/en) to test and use the App for free.
